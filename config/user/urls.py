...
urlpatterns = [
    ...
    path('add-employer-images/', SaveEmployerImagesView.as_view(), name='add-employer-images'),
    path('create-employer/', SaveEmployerDataView.as_view(), name='create-employer'),
